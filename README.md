...
### 使い方
> toot[ -r トゥートID][ -t 'トゥートの内容'][ -w '警告文'][ -v '公開範囲'][ -f 'メディア・ファイルのパス 1'[ -f 'メディア・ファイルのパス 2'[ -f 'メディア・ファイルのパス 3'[ -f 'メディア・ファイルのパス 4']]]]

  -r オプションを指定するとトゥートIDで指定したトゥートへのリプライになります。  
  -w オプションを指定するとContents Warningを指定したことになります。  
  -vオプションの公開範囲に指定できるのは "direct"、"private"、"unlisted"、"public" のいずれか。  
